...
class NavigatorKeyboardsBuilder:
    ...
    def get_go_to(self, locale: str, where: str):
    ...
    def get_go_to_menu_main(self, locale: str):
        keyboard = InlineKeyboardMarkup(
            inline_keyboard=[
                [InlineKeyboardButton(
                    text=self.translation_service.translate(message_id='to-menu-main', locale=locale),
    ...
    def get_send_menu_main(self, locale: str):
        keyboard = InlineKeyboardMarkup(
            inline_keyboard=[
                [InlineKeyboardButton(
                    text=self.translation_service.translate(message_id='open-menu-main', locale=locale),
