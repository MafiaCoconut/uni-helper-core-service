...
welcome-message =
    ...
    🍽 <b>Меню Mensa:</b> Ти можеш дізнатися поточне меню, щоб завжди бути в курсі щоденних пропозицій.

    📬 <b>Розсилання меню:</b> Отримуй щоденні меню з обраної тобою їдальні.

    📅 <b>Запис у Stadbüro:</b> Легко перевіряй вільні слоти для запису у Stadbüro.

    🔗 <b>Посилання:</b> Отримуй швидкий доступ до корисних посиланнях на сайти університету і не тільки..
...
canteen-deactivated =
    Вибрана вами їдальня була тимчасово відключена.
    Ви можете вибрати іншу їдальню для розсилки в меню налаштувань.

    Коли їдальня буде знову доступна, ви отримаєте повідомлення.

canteen-reactivated =
    Їдальня <b>{$canteen_name}</b> знову доступна для розсилки.
