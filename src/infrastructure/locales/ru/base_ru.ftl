...
welcome-message =
    ...
    🍽 <b>Меню Mensa:</b> Ты можешь узнать текущее меню, чтобы всегда быть в курсе предложений на сегодня.

    📬 <b>Рассылка меню:</b> Получить ежедневное меню из выбранной тобой столовой.

    📅 <b>Термины в Stadbüro:</b> Легко проверить свободные слоты для записи в Stadbüro.

    🔗 <b>Ссылки:</b> Получить быстрый доступ к полезным ссылкам на сайты университета и не только.
...
canteen-deactivated =
    Выбранная вами столовая была временно отключена.
    Вы можете выбрать другую столовую для рассылки в меню настроек.

    Когда столовая будет вновь доступна, вы получите уведомление.

canteen-reactivated =
    Столовая <b>{$canteen_name}</b> вновь доступна для рассылки.
