from application.telegram.handlers.admin_menu_handler import AdminMenuHandler
...
from application.telegram.handlers.settings_handler import SettingsHandler
...
from infrastructure.config.services_config import translation_service, canteens_service, stadburo_service, \
    users_service, authorization_service, settings_service, admins_service
